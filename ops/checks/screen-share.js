...
const SCREENS = [
  ...
  // The hero's demonstration is the live Python editor (first-use review, 11
  // September); the avatar demo moved down to the JavaScript games.
  { name: 'home (new)',       url: '/',         want: '.studio-hero__actions, .tryp', came: 'the two doors and the live Python editor', union: true },
