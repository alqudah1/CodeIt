...
const BASE_PAGES = [
  ...
  },
  {
    ...
    title: 'Learn Python for Kids: Free Step-by-Step Lessons | CodeIt',
    description: 'Learn beginner Python with interactive lessons on variables, strings, if statements, loops, lists, and functions.',
    eyebrow: 'Learn Python',
    h1: 'A beginner-friendly way for kids to learn Python.',
    intro: 'Python has readable syntax and gives beginners quick feedback. CodeIt introduces each idea in plain language, then gives students a place to run and change the code.',
    detail: 'The learning path progresses from a first print statement to programs that use decisions, loops, lists, and functions.',
    type: 'LearningResource',
  },
  {
    route: '/python-games-for-kids',
    title: 'Python Games for Kids: Learn by Building & Playing | CodeIt',
    description: 'Practice Python concepts through browser-based games, puzzles, scores, and beginner coding challenges.',
    eyebrow: 'Python games',
    h1: 'Turn Python practice into a challenge.',
    intro: 'Coding games give variables, decisions, and loops a visible purpose. Students can solve a challenge, see the result, and understand why the program behaves that way.',
    detail: 'CodeIt pairs playable activities with lessons so each game reinforces a real beginner programming skill.',
    type: 'LearningResource',
  },
  {
    route: '/blog',
