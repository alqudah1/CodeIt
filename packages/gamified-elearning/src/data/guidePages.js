...
CodeIt is a browser-based studio where kids build websites, games and quizzes, then inspect and edit the real HTML, CSS and JavaScript behind them. It also has AI-assisted project generation where the result stays editable instead of becoming a locked AI result. The loop is: make something, see the code, change the code, save the project, share what was built. Ages 5 to 18, with parent-managed, email-verified private profiles for ages 5 to 12 and independent accounts from 13. The free plan does not expire, needs no card, and includes ten assisted project builds a month with two learner profiles under a parent view. A paid family plan is available at CA$12 a month and can be cancelled at any time.
...
CodeIt is a browser-based studio where kids build websites, games and quizzes, then inspect and edit the real HTML, CSS and JavaScript behind them. The AI-assisted project generation is built so the result stays editable instead of becoming a locked AI result — the specific mechanic this page is about. The loop is: make something, see the code, change the code, save the project, share what was built. Ages 5 to 18, with parent-managed, email-verified private profiles for ages 5 to 12 and independent accounts from 13. The free plan does not expire, needs no card, and includes ten assisted project builds a month with two learner profiles under a parent view. A paid family plan is available at CA$12 a month and can be cancelled at any time.
