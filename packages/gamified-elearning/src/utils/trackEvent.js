...
const CLIENT_EVENTS = new Set(["acquisition_visit", "landing_cta_click", "learning_start", "parent_guide_view", "parent_cta_click", "guest_draft_recovered", "project_personalize", "activation_account_gate", "activation_next_step", "project_share", "return_use", "pricing_view"]);
