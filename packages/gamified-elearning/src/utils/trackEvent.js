...
const CLIENT_EVENTS = new Set(["acquisition_visit", "landing_cta_click", "parent_cta_click", "project_personalize", "activation_next_step", "project_share", "return_use", "pricing_view", "pricing_interest"]);
