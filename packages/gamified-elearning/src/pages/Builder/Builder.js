...
const PRESET_PALETTES = [
  { name: 'CodeIt', swatches: ['#FF7A00', '#A855F7', '#10B981'],
    vars: { '--primary': '#FF7A00', '--accent': '#A855F7', '--success': '#10B981', '--bg': '#FFF6ED', '--card': '#FFFFFF', '--border': '#FED7AA', '--text': '#1F2937', '--muted': '#6B7280' } },
  ...
  { name: 'Forest', swatches: ['#22C55E', '#F59E0B', '#10B981'],
    vars: { '--primary': '#22C55E', '--accent': '#F59E0B', '--success': '#10B981', '--bg': '#F0FDF4', '--card': '#FFFFFF', '--border': '#BBF7D0', '--text': '#14532D', '--muted': '#6B7280' } },
  { name: 'Candy',  swatches: ['#EC4899', '#A855F7', '#10B981'],
    vars: { '--primary': '#EC4899', '--accent': '#A855F7', '--success': '#10B981', '--bg': '#FFF0F6', '--card': '#FFFFFF', '--border': '#F9A8D4', '--text': '#1F2937', '--muted': '#6B7280' } },
  { name: 'Night',  swatches: ['#8B5CF6', '#06B6D4', '#10B981'],
    vars: { '--primary': '#8B5CF6', '--accent': '#06B6D4', '--success': '#10B981', '--bg': '#0F0A1E', '--card': '#1E1535', '--border': '#3D2B6E', '--text': '#F3F4F6', '--muted': '#9CA3AF' } },
];
...
function getProjectGradient(type) {
  ...
  if (/tool|calculator|timer|drawing|flashcard/.test(t)) return 'linear-gradient(135deg, #6B7280 0%, #10B981 100%)';
...
export default function Builder() {
  ...
  useEffect(() => {
    if (studioPanel === 'colors' && code) {
      ...
      setCustomText(code.match(/--text:\s*(#[\da-fA-F]{3,8})/)?.[1] || '#1F2937');
    }
