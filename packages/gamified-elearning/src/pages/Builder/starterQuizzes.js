...
const STARTER_QUIZZES = [
  {
    ...
    label: 'Animal quiz',
    emoji: '🐾',
    blurb: 'Five questions. Make them yours!',
  ...
  },
  {
    ...
    emoji: '➗',
    blurb: 'Ten sums. New ones every time!',
  ...
  },
  {
    ...
    emoji: '🔮',
    blurb: 'No wrong answers. Just fun picks!',
